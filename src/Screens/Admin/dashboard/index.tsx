...
import AddCourse from '../Admin_screen/AddCourse';
import CourseList from '../Admin_screen/ComplaintList';
            ...
            >
                <Toolbar>
                    ...
                    <Typography variant="h3" noWrap className='ms-5' component="div">
                        <BAButton variant='contained' onClick={()=> navigate('/student-dashboard')} label={'Go Back'} />
                    </Typography>
                </Toolbar>
            </AppBar>
            <Box
